...
@section('page-title', 'Add IQAC Document')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add IQAC Document</h2>

        <p class="admin-page-subtitle">
            Add SSR document or AQAR report with downloadable file
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.iqac-documents.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Select type and enter document details</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="document_type"
                            ...
                            <option value="ssr" {{ old('document_type') == 'ssr' ? 'selected' : '' }}>SSR</option>
                            <option value="aqar" {{ old('document_type') == 'aqar' ? 'selected' : '' }}>AQAR</option>
                        </select>
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="icon_class"
                               id="icon_class"
                               value="{{ old('icon_class', 'bi bi-file-earmark-pdf') }}"
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Upload PDF, document or image file</p>
                </div>
            </div>
