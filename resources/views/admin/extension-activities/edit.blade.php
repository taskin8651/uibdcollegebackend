...
@section('page-title', 'Edit Extension Activity')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Extension Activity</h2>

        <p class="admin-page-subtitle">
            Update extension activity detail page content
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.extension-activities.update', $extensionActivity->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="title"
                               id="title"
                               value="{{ old('title', $extensionActivity->title) }}"
                               required
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="slug"
                               id="slug"
                               value="{{ old('slug', $extensionActivity->slug) }}"
                               placeholder="debate-club"
                    ...
                    @else
                        <p class="field-hint">Slug frontend URL me use hota hai.</p>
                    @endif
                </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="icon_class"
                               id="icon_class"
                               value="{{ old('icon_class', $extensionActivity->icon_class) }}"
                ...
                <div class="field-group">
                    ...
                    <textarea name="short_description"
                              ...
                              class="field-textarea {{ $errors->has('short_description') ? 'error' : '' }}">{{ old('short_description', $extensionActivity->short_description) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number"
                               name="sort_order"
                               id="sort_order"
                               value="{{ old('sort_order', $extensionActivity->sort_order) }}"
                               min="0"
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('status', $extensionActivity->status) ? 'checked' : '' }}">
                        ...
                        <input type="checkbox"
                               ...
                               value="1"
                               class="role-checkbox"
                               {{ old('status', $extensionActivity->status) ? 'checked' : '' }}>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="hero_label"
                               id="hero_label"
                               value="{{ old('hero_label', $extensionActivity->hero_label) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="hero_title"
                               id="hero_title"
                               value="{{ old('hero_title', $extensionActivity->hero_title) }}"
                               placeholder="Debate Club"
                ...
                <div class="field-group">
                    ...
                    <textarea name="hero_description"
                              ...
                              class="field-textarea {{ $errors->has('hero_description') ? 'error' : '' }}">{{ old('hero_description', $extensionActivity->hero_description) }}</textarea>
                </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="card_title"
                               id="card_title"
                               value="{{ old('card_title', $extensionActivity->card_title) }}"
                               placeholder="Debate Club"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="card_subtitle"
                               id="card_subtitle"
                               value="{{ old('card_subtitle', $extensionActivity->card_subtitle) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap mb-2">
                        ...
                        <input type="text" name="pill_one" value="{{ old('pill_one', $extensionActivity->pill_one) }}" placeholder="Speaking" class="field-input">
                    </div>

                    <div class="input-icon-wrap mb-2">
                        <i class="fas fa-circle icon"></i>
                        <input type="text" name="pill_two" value="{{ old('pill_two', $extensionActivity->pill_two) }}" placeholder="Confidence" class="field-input">
                    </div>

                    <div class="input-icon-wrap">
                        <i class="fas fa-circle icon"></i>
                        <input type="text" name="pill_three" value="{{ old('pill_three', $extensionActivity->pill_three) }}" placeholder="Leadership" class="field-input">
                    </div>
                </div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="about_kicker"
                               id="about_kicker"
                               value="{{ old('about_kicker', $extensionActivity->about_kicker) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="about_title"
                               id="about_title"
                               value="{{ old('about_title', $extensionActivity->about_title) }}"
                ...
                <div class="field-group">
                    ...
                    <textarea name="about_description_one"
                              ...
                              class="field-textarea">{{ old('about_description_one', $extensionActivity->about_description_one) }}</textarea>
                </div>
                ...
                <div class="field-group">
                    ...
                    <textarea name="about_description_two"
                              ...
                              class="field-textarea">{{ old('about_description_two', $extensionActivity->about_description_two) }}</textarea>
                </div>
                ...
                <div class="field-group">
                    ...
                    @if($activityImage)
                        <p class="field-hint">
                            Current image:
                            <a href="{{ $activityImage }}" target="_blank" rel="noopener">View uploaded image</a>
                        </p>
                    @else
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               id="objectives_title"
                               value="{{ old('objectives_title', $extensionActivity->objectives_title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="events_title"
                               id="events_title"
                               value="{{ old('events_title', $extensionActivity->events_title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="join_kicker"
                               id="join_kicker"
                               value="{{ old('join_kicker', $extensionActivity->join_kicker) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="join_title"
                               id="join_title"
                               value="{{ old('join_title', $extensionActivity->join_title) }}"
                ...
                <div class="field-group">
                    ...
                    <textarea name="join_description"
                              ...
                              class="field-textarea">{{ old('join_description', $extensionActivity->join_description) }}</textarea>
                </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="email"
                               name="contact_email"
                               id="contact_email"
                               value="{{ old('contact_email', $extensionActivity->contact_email) }}"
                ...
                <div class="field-group">
                    ...
                    @if($joinForm)
                        <p class="field-hint">
                            Current form:
                            <a href="{{ $joinForm }}" target="_blank" rel="noopener">View uploaded form</a>
                        </p>
                    @else
