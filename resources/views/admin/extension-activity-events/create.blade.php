...
@section('page-title', 'Add Activity Event')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Activity Event</h2>

        <p class="admin-page-subtitle">
            Add activity, programme, workshop or event card
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.extension-activity-events.store') }}">
    @csrf
