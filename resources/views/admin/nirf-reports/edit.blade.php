...
@section('page-title', 'Edit NIRF Report')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit NIRF Report</h2>

        <p class="admin-page-subtitle">
            Update NIRF report heading, year, date and downloadable file
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.nirf-reports.update', $nirfReport->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="heading"
                               id="heading"
                               value="{{ old('heading', $nirfReport->heading) }}"
                               required
                ...
                <div class="field-group">
                    ...
                    <textarea name="description"
                              ...
                              class="field-textarea {{ $errors->has('description') ? 'error' : '' }}">{{ old('description', $nirfReport->description) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="publish_year"
                               id="publish_year"
                               value="{{ old('publish_year', $nirfReport->publish_year) }}"
                               placeholder="2026"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="date"
                               name="publish_date"
                               id="publish_date"
                               value="{{ old('publish_date', $nirfReport->publish_date ? $nirfReport->publish_date->format('Y-m-d') : '') }}"
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="badge_label"
                               id="badge_label"
                               value="{{ old('badge_label', $nirfReport->badge_label) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="badge_class"
                            ...
                            <option value="muted" {{ old('badge_class', $nirfReport->badge_class) == 'muted' ? 'selected' : '' }}>Muted / Archive</option>
                        </select>
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number"
                               name="sort_order"
                               id="sort_order"
                               value="{{ old('sort_order', $nirfReport->sort_order) }}"
                               min="0"
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('status', $nirfReport->status) ? 'checked' : '' }}">
                        ...
                        <input type="checkbox"
                               ...
                               value="1"
                               class="role-checkbox"
                               {{ old('status', $nirfReport->status) ? 'checked' : '' }}>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Upload or replace PDF/document file</p>
                </div>
            </div>
