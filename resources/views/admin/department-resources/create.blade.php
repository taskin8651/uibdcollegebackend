...
@section('page-title', 'Add Department Resource')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Department Resource</h2>

        <p class="admin-page-subtitle">
            Upload syllabus, timetable or academic resource file
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.department-resources.store') }}" enctype="multipart/form-data">
    @csrf
