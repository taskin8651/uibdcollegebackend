...
@section('page-title', 'Add Activity Objective')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Activity Objective</h2>

        <p class="admin-page-subtitle">
            Add objective card for extension activity detail page
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.extension-activity-objectives.store') }}">
    @csrf
