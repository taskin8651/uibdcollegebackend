...
@section('page-title', 'Edit Digital Initiative')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Digital Initiative</h2>

        <p class="admin-page-subtitle">
            Update digital learning resource content
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.digital-initiatives.update', $digitalInitiative->id) }}">
    @csrf
    @method('PUT')
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <input type="text"
                           name="icon_class"
                           id="icon_class"
                           value="{{ old('icon_class', $digitalInitiative->icon_class) }}"
                ...
                <div class="field-group">
                    ...
                    <input type="text"
                           name="title"
                           id="title"
                           value="{{ old('title', $digitalInitiative->title) }}"
                           required
                           placeholder="SWAYAM"
                ...
                <div class="field-group">
                    ...
                    <textarea name="description"
                              ...
                              class="field-textarea {{ $errors->has('description') ? 'error' : '' }}">{{ old('description', $digitalInitiative->description) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <input type="url"
                           name="url"
                           id="url"
                           value="{{ old('url', $digitalInitiative->url) }}"
                ...
                <div class="field-group">
                    ...
                    <input type="number"
                           name="sort_order"
                           id="sort_order"
                           value="{{ old('sort_order', $digitalInitiative->sort_order) }}"
                           min="0"
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('status', $digitalInitiative->status) ? 'checked' : '' }}">
                        ...
                        <input type="checkbox"
                               ...
                               value="1"
                               class="role-checkbox"
                               {{ old('status', $digitalInitiative->status) ? 'checked' : '' }}>
