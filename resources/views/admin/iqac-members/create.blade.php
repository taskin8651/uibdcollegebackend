...
@section('page-title', 'Add IQAC Member')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add IQAC Member</h2>

        <p class="admin-page-subtitle">
            Add new IQAC committee member
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.iqac-members.store') }}">
    @csrf
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="role_class"
                            ...
                            <option value="chairman" {{ old('role_class') == 'chairman' ? 'selected' : '' }}>Chairman</option>
                            <option value="coordinator" {{ old('role_class') == 'coordinator' ? 'selected' : '' }}>Coordinator</option>
                            <option value="advisor" {{ old('role_class') == 'advisor' ? 'selected' : '' }}>Advisor</option>
                            <option value="teacher" {{ old('role_class') == 'teacher' ? 'selected' : '' }}>Teacher</option>
                            <option value="admin" {{ old('role_class') == 'admin' ? 'selected' : '' }}>Admin</option>
                            <option value="university" {{ old('role_class') == 'university' ? 'selected' : '' }}>University</option>
                            <option value="society" {{ old('role_class') == 'society' ? 'selected' : '' }}>Society</option>
                            <option value="alumni" {{ old('role_class') == 'alumni' ? 'selected' : '' }}>Alumni</option>
                            <option value="student" {{ old('role_class') == 'student' ? 'selected' : '' }}>Student</option>
                        </select>
                    </div>
