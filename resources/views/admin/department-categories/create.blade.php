...
@section('page-title', 'Add Department Category')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Department Category</h2>

        <p class="admin-page-subtitle">
            Create a new department section/category
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.department-categories.store') }}">
    @csrf
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="layout_type"
                            ...
                            <option value="table" {{ old('layout_type') == 'table' ? 'selected' : '' }}>Table</option>
                            <option value="card" {{ old('layout_type', 'card') == 'card' ? 'selected' : '' }}>Card</option>
                            <option value="feature" {{ old('layout_type') == 'feature' ? 'selected' : '' }}>Feature</option>
                            <option value="professional" {{ old('layout_type') == 'professional' ? 'selected' : '' }}>Professional</option>
                            <option value="common" {{ old('layout_type') == 'common' ? 'selected' : '' }}>Common</option>
                        </select>
                    </div>
