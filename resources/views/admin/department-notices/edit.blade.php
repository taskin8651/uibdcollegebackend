...
@section('page-title', 'Edit Department Notice')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Department Notice</h2>

        <p class="admin-page-subtitle">
            Update department-wise notice or update
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.department-notices.update', $departmentNotice->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="form-card-body">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="department_id"
                            ...
                            @foreach($departments as $id => $department)
                                <option value="{{ $id }}" {{ old('department_id', $departmentNotice->department_id) == $id ? 'selected' : '' }}>
                                    {{ $department }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="title"
                               id="title"
                               value="{{ old('title', $departmentNotice->title) }}"
                               required
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="date"
                               name="notice_date"
                               id="notice_date"
                               value="{{ old('notice_date', optional($departmentNotice->notice_date)->format('Y-m-d')) }}"
                ...
                <div class="field-group">
                    ...
                    <textarea name="description"
                              ...
                              class="field-textarea {{ $errors->has('description') ? 'error' : '' }}">{{ old('description', $departmentNotice->description) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number"
                               name="sort_order"
                               id="sort_order"
                               value="{{ old('sort_order', $departmentNotice->sort_order) }}"
                               min="0"
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('status', $departmentNotice->status) ? 'checked' : '' }}">
                        ...
                        <input type="checkbox"
                               ...
                               value="1"
                               class="role-checkbox"
                               {{ old('status', $departmentNotice->status) ? 'checked' : '' }}>
