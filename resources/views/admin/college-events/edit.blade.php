...
@section('page-title', 'Edit College Event')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit College Event</h2>

        <p class="admin-page-subtitle">
            Update event title, date, venue, details, image and downloadable PDF
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.college-events.update', $collegeEvent->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="title"
                               id="title"
                               value="{{ old('title', $collegeEvent->title) }}"
                               required
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="slug"
                               id="slug"
                               value="{{ old('slug', $collegeEvent->slug) }}"
                               placeholder="seminar-on-world-museum-day"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="date"
                               name="event_date"
                               id="event_date"
                               value="{{ old('event_date', $collegeEvent->event_date ? $collegeEvent->event_date->format('Y-m-d') : '') }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="location"
                               id="location"
                               value="{{ old('location', $collegeEvent->location) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="organizer"
                               id="organizer"
                               value="{{ old('organizer', $collegeEvent->organizer) }}"
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <textarea name="short_description"
                              ...
                              class="field-textarea {{ $errors->has('short_description') ? 'error' : '' }}">{{ old('short_description', $collegeEvent->short_description) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <textarea name="description"
                              ...
                              class="field-textarea {{ $errors->has('description') ? 'error' : '' }}">{{ old('description', $collegeEvent->description) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <textarea name="instructions"
                              ...
                              class="field-textarea {{ $errors->has('instructions') ? 'error' : '' }}">{{ old('instructions', $collegeEvent->instructions) }}</textarea>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="button_label"
                               id="button_label"
                               value="{{ old('button_label', $collegeEvent->button_label) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number"
                               name="sort_order"
                               id="sort_order"
                               value="{{ old('sort_order', $collegeEvent->sort_order) }}"
                               min="0"
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('status', $collegeEvent->status) ? 'checked' : '' }}">
                        ...
                        <input type="checkbox"
                               ...
                               value="1"
                               class="role-checkbox"
                               {{ old('status', $collegeEvent->status) ? 'checked' : '' }}>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Upload or replace event image and PDF/document file</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="document_title"
                               id="document_title"
                               value="{{ old('document_title', $collegeEvent->document_title) }}"
                               placeholder="Seminar on World Museum Day"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('document_subtitle', $collegeEvent->document_subtitle) }}"
