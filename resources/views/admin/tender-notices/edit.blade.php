...
@section('page-title', 'Edit Tender Notice')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Tender Notice</h2>

        <p class="admin-page-subtitle">
            Update tender heading, details, dates and document file
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.tender-notices.update', $tenderNotice->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="heading"
                               id="heading"
                               value="{{ old('heading', $tenderNotice->heading) }}"
                               required
                ...
                <div class="field-group">
                    ...
                    <textarea name="details"
                              ...
                              class="field-textarea {{ $errors->has('details') ? 'error' : '' }}">{{ old('details', $tenderNotice->details) }}</textarea>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="date"
                               name="publish_date"
                               id="publish_date"
                               value="{{ old('publish_date', $tenderNotice->publish_date ? $tenderNotice->publish_date->format('Y-m-d') : '') }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="date"
                               name="expire_date"
                               id="expire_date"
                               value="{{ old('expire_date', $tenderNotice->expire_date ? $tenderNotice->expire_date->format('Y-m-d') : '') }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number"
                               name="sort_order"
                               id="sort_order"
                               value="{{ old('sort_order', $tenderNotice->sort_order) }}"
                               min="0"
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('status', $tenderNotice->status) ? 'checked' : '' }}">
                        ...
                        <input type="checkbox"
                               ...
                               value="1"
                               class="role-checkbox"
                               {{ old('status', $tenderNotice->status) ? 'checked' : '' }}>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Upload or replace tender document file</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="document_title"
                               id="document_title"
                               value="{{ old('document_title', $tenderNotice->document_title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('document_subtitle', $tenderNotice->document_subtitle) }}"
