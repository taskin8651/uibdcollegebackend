...
@section('page-title', 'Add Principal History')
...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Create a new principal history record
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.principal-histories.store') }}">
    @csrf
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="badge_type"
                            ...
                            <option value="principal" {{ old('badge_type') == 'principal' ? 'selected' : '' }}>
                                Principal
                            </option>
                            <option value="incharge" {{ old('badge_type') == 'incharge' ? 'selected' : '' }}>
                                Principal-in-Charge
                            </option>
                            <option value="current" {{ old('badge_type') == 'current' ? 'selected' : '' }}>
                                Current Principal
                            </option>
                        </select>
                    </div>
