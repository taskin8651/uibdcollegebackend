...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Upload administration gallery or media coverage image
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.administration-galleries.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('is_big') ? 'checked' : '' }}">
