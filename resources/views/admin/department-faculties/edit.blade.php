...
@section('page-title', 'Edit Department Faculty')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Department Faculty</h2>

        <p class="admin-page-subtitle">
            Update department-wise faculty member
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.department-faculties.update', $departmentFaculty->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="form-card-body">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="department_id"
                            ...
                            @foreach($departments as $id => $department)
                                <option value="{{ $id }}" {{ old('department_id', $departmentFaculty->department_id) == $id ? 'selected' : '' }}>
                                    {{ $department }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="name"
                               id="name"
                               value="{{ old('name', $departmentFaculty->name) }}"
                               required
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="designation"
                               id="designation"
                               value="{{ old('designation', $departmentFaculty->designation) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="qualification"
                               id="qualification"
                               value="{{ old('qualification', $departmentFaculty->qualification) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="specialization"
                               id="specialization"
                               value="{{ old('specialization', $departmentFaculty->specialization) }}"
                ...
                <div class="field-group">
                    ...
                    @if($facultyImage)
                        <p class="field-hint">
                            Current image:
                            <a href="{{ $facultyImage }}" target="_blank" rel="noopener">View uploaded image</a>
                        </p>
                    @else
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number"
                               name="sort_order"
                               id="sort_order"
                               value="{{ old('sort_order', $departmentFaculty->sort_order) }}"
                               min="0"
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('status', $departmentFaculty->status) ? 'checked' : '' }}">
                        ...
                        <input type="checkbox"
                               ...
                               value="1"
                               class="role-checkbox"
                               {{ old('status', $departmentFaculty->status) ? 'checked' : '' }}>
