...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Update academic department, cell or unit
        </p>
    </div>
</div>
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="department_category_id"
                            ...
                            @foreach($categories as $id => $category)
                                <option value="{{ $id }}" {{ old('department_category_id', $department->department_category_id) == $id ? 'selected' : '' }}>
                                    {{ $category }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="class_level"
                               id="class_level"
                               value="{{ old('class_level', $department->class_level) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="badge_type"
                            ...
                            <option value="ug" {{ old('badge_type', $department->badge_type) == 'ug' ? 'selected' : '' }}>UG</option>
                            <option value="pg" {{ old('badge_type', $department->badge_type) == 'pg' ? 'selected' : '' }}>PG</option>
                            <option value="ug_pg" {{ old('badge_type', $department->badge_type) == 'ug_pg' ? 'selected' : '' }}>UG & PG</option>
                            <option value="common" {{ old('badge_type', $department->badge_type) == 'common' ? 'selected' : '' }}>Common</option>
                        </select>
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="icon_class"
                               id="icon_class"
                               value="{{ old('icon_class', $department->icon_class) }}"
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <textarea name="description_one"
                              ...
                              class="field-textarea {{ $errors->has('description_one') ? 'error' : '' }}">{{ old('description_one', $department->description_one) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <textarea name="description_two"
                              ...
                              class="field-textarea {{ $errors->has('description_two') ? 'error' : '' }}">{{ old('description_two', $department->description_two) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    @if($departmentImage)
                        <p class="field-hint">
                            Current image:
                            <a href="{{ $departmentImage }}" target="_blank" rel="noopener">View uploaded image</a>
                        </p>
                    @else
